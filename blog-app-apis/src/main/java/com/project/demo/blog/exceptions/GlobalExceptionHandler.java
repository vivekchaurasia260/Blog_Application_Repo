...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Map<String, String>> methodArgumentNotValidExceptionHandler(MethodArgumentNotValidException mac) {
		Map<String, String> response = new HashMap<>();
		mac.getBindingResult().getAllErrors().forEach((error) -> {
